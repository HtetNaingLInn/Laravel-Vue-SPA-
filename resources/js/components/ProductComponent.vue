      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-header">
            <h4 class="text-info">{{ editMode ? "edit" : "create" }}</h4>
          </div>
          <div class="card-body">
            <form
              v-on:submit.prevent="
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="product in products.data" :key="product.id">
              ...
              <td>{{ product.price }}</td>
              <td>
                <button class="btn btn-success btn-sm" v-on:click="productEdit(product)">
                  <i class="fas fa-edit"></i>&nbsp;Edit
                </button>
                <button class="btn btn-danger btn-sm" v-on:click="productDelete(product.id)">
